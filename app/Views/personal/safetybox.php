    ...
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-xl-down">
        <article class="modal-content border-0">
            <div class="modal-body p-0">
                ...
                <div class="d-grid gap-2">
                    <button type="submit" class="btn btn-primary"><?=lang('Nav.submit');?></button>
                    <a target="_blank" class="btn btn-secondary whatsapp" href="javascript:void(0):"><i class='bx bxl-whatsapp'></i>Whatsapp</a>
                </div>
                <?=form_close();?>
            </div>
        </article>
...
document.addEventListener('DOMContentLoaded', (event) => {
    $('.sideNav-profile [data-page=vault]').addClass('active');
