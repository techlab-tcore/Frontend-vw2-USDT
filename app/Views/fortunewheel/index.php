            ...
            <dl class="row m-0 g-2">
                ...
                <dd class="col-xl-4 col-lg-4 col-md-4 col-12">
                    <article class="topList">
                        ...
                        <thead class="text-center bg-primary"><tr><th><?=lang('Label.player');?></th><th><?=lang('Label.prize');?></th></tr></thead>
                        <tbody class="text-center bg-white" id="topList"></tbody>
                        </table>
                    </article>
...
document.addEventListener('DOMContentLoaded', (event) => {
    $('.sideMainNav [data-page=fortunew]').addClass("active");
